...
PROTOCOL_SHA = 'b2521df119bc7877729154b45fbc19dd31474afe620a0f864df31a3e68e892b9'
NAMES = ('CC', 'CO', 'OC', 'OO')
...
def stage(root, mode, complete_sha, policy, inputs):
    ...
    require(summary['sources']['source_sha256'] == manifest['source_sha256'] == policy['source_sha256'] and
            summary['sources']['script_sha256'] == policy['source_sha256']['readout_transition_diagnostic.py'] and
...
def load_inputs(args):
    ...
    require(manifest['schema'] == 'readout-transition-campaign-v1' and manifest['diagnostic_protocol_sha256'] == PROTOCOL_SHA and
            manifest['wrapper_sha256'] == policy['source_sha256']['run_readout_transition_campaign.py'] and
    ...
    producer = module('readout_transition_diagnostic.py', policy, inputs)
...
def main(argv=None):
    ...
    parser.add_argument('--diagnostic-protocol', default=str(PKG/'readout_transition_diagnostic_protocol_v1.json'))
    ...
    receipt = dict(schema='readout-transition-results-plot-v1', status='RENDERED_PENDING_VISUAL_QA',
