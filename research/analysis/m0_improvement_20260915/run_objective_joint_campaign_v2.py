...
from objective_joint_evaluation_v2 import load_contracts, full_gate, read, require, resolve, sha
...
def main(argv=None):
    ...
    manifest = dict(schema='objective-joint-two-gpu-campaign-v2', mode=args.mode,
    ...
    try:
        for index in (0, 1):
            command = [sys.executable, '-B', str(package/'objective_joint_evaluation_v2.py'),
        ...
        command = [sys.executable, '-B', str(package/'objective_joint_merge_v2.py'),
