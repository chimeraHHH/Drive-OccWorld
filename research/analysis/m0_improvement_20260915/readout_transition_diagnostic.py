...
def load_evidence(a, policy, development):
    ...
    crec['training'] = audit.check_log(a.control_run, helper, parent['training'])
    crec['checkpoint'] = audit.check_payload(a.control_run, control, objective['control_files_sha256']['latest.pth'],
    ...
    for name, receipt in [('native1',crec), ('O',orec)]:
        require(receipt == development['source_receipts'][name], 'Actual final source audit differs: '+name)
