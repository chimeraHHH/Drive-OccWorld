...
def source_function(path, name):
    ...
    # inspect.getsource(bound_method) returns complete source lines, including
    # the initial class indentation. ast.get_source_segment omits indentation
    # only on the first line and therefore changes docstring AST text on dedent.
    node=nodes[0]
