...
# inspect.getsource(method) followed by dedent, including docstring indentation.
# Full-file AST has 8dfd862e...; that is a different exact extraction contract.
ALIGN_AST_SHA256 = '85592ae2ff88b4e180132bb4abf93efee8bb177e614be86fc1b8f1dc07fe39d5'
...
def install_frame_consistent_adapter(model, mode='reference'):
    ...
    receipt = dict(schema='m0-frame-consistent-adapter-v2', mode=mode,
