...
def main(argv=None):
    ...
    require(policy['total_max_seconds'] == 1800 and policy['max_allocated_gib'] == 32 and
            policy['pilot'] == {'max_seconds': 300, 'max_allocated_gib': 32} and
            policy['development_ceiling'] == {'max_seconds': 1500, 'max_allocated_gib': 32},
    ...
    try:
        ...
        def run_stage(mode, cap, extra=None):
            ...
            command = [sys.executable, '-B', str(package/'readout_transition_diagnostic_v2.py')]+common+[
