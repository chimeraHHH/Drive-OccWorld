...
def load_policy(a):
    ...
    require(0 < resource['total_max_seconds'] <= 3600 and 0 < resource['max_allocated_gib'] <= 32,
...
def main(argv=None):
    ...
    require(0 < a.max_seconds <= 3600 and 0 < a.max_allocated_gib <= 32 and a.device.startswith('cuda:'), 'Invalid bounded CUDA execution')
