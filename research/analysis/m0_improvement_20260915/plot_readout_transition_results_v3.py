...
PROTOCOL_SHA = 'e760da6c6eb645b0f2862a58bd37a340d97ed94c51d254384fe084c71386695a'
NAMES = ('CC', 'CO', 'OC', 'OO')
...
def stage(root, mode, complete_sha, policy, inputs):
    ...
    require(summary['sources']['source_sha256'] == manifest['source_sha256'] == policy['source_sha256'] and
            summary['sources']['script_sha256'] == policy['source_sha256']['readout_transition_diagnostic_v3.py'] and
...
def load_inputs(args):
    ...
    require(manifest['schema'] == 'readout-transition-campaign-v1' and manifest['diagnostic_protocol_sha256'] == PROTOCOL_SHA and
            manifest['wrapper_sha256'] == policy['source_sha256']['run_readout_transition_campaign_v3.py'] and
    ...
    producer = module('readout_transition_diagnostic_v3.py', policy, inputs)
...
def main(argv=None):
    ...
    parser.add_argument('--diagnostic-protocol', default=str(PKG/'readout_transition_diagnostic_protocol_v3.json'))
    ...
    receipt = dict(schema='readout-transition-results-plot-v3', status='RENDERED_PENDING_VISUAL_QA',
        ...
        engineering_revision=3, previous_plot_script_sha256='04ecd07accba5fc35577279e36cd861940ec488da2a5f6bd150d29ca033ce5b7',
