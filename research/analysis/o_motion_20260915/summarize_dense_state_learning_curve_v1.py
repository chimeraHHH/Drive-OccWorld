...
def main(a):
    ...
    report=dict(status='VERIFIED_TRAIN4_LEARNING_CURVE_AGGREGATES',source_complete_sha256=sha(root/'complete.json'),
    ...
    colors={'P':'#3288bd','J':'#d95f02','D':'#7570b3'}
    labels={'P':'Physical only','J':'Joint + transport','D':'Joint + direct'}
    ...
    fig.suptitle('Train-only learnability • 4 samples • frozen codec • seed 11',fontsize=12,fontweight='bold')
