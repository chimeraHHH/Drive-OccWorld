"""Pool common outputs with J-minus-D and R-minus-R0 comparisons; paired bootstrap resamples scenes.
...
def summarize(rows, bootstrap_repetitions=10000, seed=11):
    ...
    return finite_json(dict(schema='common-change-pooled-summary-v3', samples=len(rows), scenes=len(scenes),
