...
root=n/'metric_surface_history_train16_evaluation_v1'
...
count=0;maximum=0.;support_counts={k:0 for k in ['in_roi','fb1_in_roi']};distances={k:[] for k in support_counts}
for audit in audits:
