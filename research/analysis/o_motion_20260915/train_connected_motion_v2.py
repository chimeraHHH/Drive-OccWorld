...
SCHEMA = 'connected-motion-training-v2'
ARMS = ('J', 'D')
SOURCES = ('train_connected_motion_v2.py', 'train_supported_fusion_v2.py',
...
def protocol_template():
    return dict(schema=SCHEMA, status='REVIEW_REQUIRED', training=copy.deepcopy(TRAINING),
        ...
        engineering=dict(independent_forward_rtol=1e-5, independent_forward_atol=1e-6,
            ...
            vjp_cudnn_tf32=False, restore_original_precision_before_training=True),
...
def engineering_probe(shared, label, models, gates, module, helper, fusion, oracle, adapter, model, numerical):
    ...
    for arm in ARMS:
        ...
        require(numerical['vjp_cudnn_tf32'] is False and numerical['restore_original_precision_before_training'],
                'Fixed high-precision diagnostic VJP required')
        original_tf32 = torch.backends.cudnn.allow_tf32
        # Only the zero-update gradient-linearity audit uses this precision.
        # All forwards and actual optimizer updates retain NUMERICAL unchanged.
        try:
        ...
        require(torch.backends.cudnn.allow_tf32 == original_tf32, 'Audit precision was not restored')
    ...
    return dict(status='PASS_INITIAL_CONNECTION_VJP', optimizer_updates=0,
        ...
        diagnostic_vjp_cudnn_tf32=False, forward_and_training_cudnn_tf32=True,
        diagnostic_precision_restored_before_training=True,
