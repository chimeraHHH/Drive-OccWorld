...
RULES_PATH = HERE / 'history_frozen_flow_evidence_train_analysis_rules_v1.json'
RULES_SHA = '6b7ecdf7fa0a4e393e69c635bad9550a6e6ad52b1d4149d3aa98871a7861d22a'
HORIZONS = (.5, 1., 1.5, 2.)
...
def authenticate_flow(a, rules, radar, cr, mr, sources):
    ...
    require(protocol['source_sha256'] == rules['flow_extractor_sha256'] == sha(HERE / 'extract_history_frozen_flow_evidence_train_v1.py') and
