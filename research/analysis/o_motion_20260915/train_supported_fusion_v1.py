...
ARMS = ('A', 'Z')
SOURCES = ('train_supported_fusion_v1.py', 'supported_motion_fusion.py', 'transport_ops.py',
    ...
    try:
        for pass_index, order in enumerate(orders):
            for ordinal in order:
                ...
                constants=audits['A']['constant_intermediate_keys']
                require(all(audits['A']['original_twelve'][k]==audits['Z']['original_twelve'][k] for k in constants), 'Fixed intermediate losses differ between arms')
