...
def run(a, out, started, stopping):
    ...
    model.eval()
    require(helper.state_digest(model.future_pred_head)==O_HEAD_SHA, 'Actual O head differs')
    ...
    write(out/'loaded_models.json',dict(native=model._native_state_provenance,
        O_head_state_sha256=O_HEAD_SHA,O_full_state_sha256=original_model_sha,
