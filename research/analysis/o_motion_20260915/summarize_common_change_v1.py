"""Pool common O/A/Z outputs before ratios; paired bootstrap resamples scenes.
...
def summarize(rows, bootstrap_repetitions=10000, seed=11):
    ...
    return finite_json(dict(schema='common-change-pooled-summary-v1', samples=len(rows), scenes=len(scenes),
