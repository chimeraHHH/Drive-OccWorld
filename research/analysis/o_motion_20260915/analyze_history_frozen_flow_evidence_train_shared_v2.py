...
RULES_PATH = HERE / 'history_frozen_flow_evidence_train_shared_analysis_rules_v2.json'
RULES_SHA = '10097af69d382882207473bfb239774308f9dbcaeca11c1b31070e415056197d'
...
def authenticate_flow(a, rules, radar, cr, mr, sources):
    ...
    require(sha(a.flow_protocol) == rules['flow_protocol_sha256'] and protocol['schema'] == FLOW_SCHEMA and
            protocol['status'] == 'FROZEN' and protocol['resources'] == dict(max_seconds=7200, cpu_threads=2, max_allocated_bytes=12*1024**3),
    ...
    require(protocol['source_sha256'] == rules['flow_extractor_sha256'] == sha(HERE / 'extract_history_frozen_flow_evidence_train_shared_v2.py') and
    ...
    require(manifest['schema'] == index['schema'] == summary['schema'] == FLOW_SCHEMA and
            ...
            index['source_points'] == 1740053 and 0 < summary['seconds'] < 7200 and
