...
# H200 x2 M1+M2: physical global batch 4 and four workers per GPU.
...
work_dir=${workspace}/work_dirs/gmo_radar_m1_m2_v1_h200720_cached_w4_2g_b2_seed0_scratch
...
log_file=${work_dir}/strict_h200_2g_b2_w4_m1_m2_scratch.log
