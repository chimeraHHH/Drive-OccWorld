...
# Independent H200 GPU 1 run: M1+M2, physical batch size 4, from Epoch 1.
...
work_dir=${workspace}/work_dirs/gmo_radar_m1_m2_v1_h200_gpu1_720_cached_w2_1g_b4_seed0_scratch
pretrained_checkpoint=${code_dir}/pretrained/r101_dcn_fcos3d_pretrain.pth
radar_cache=${code_dir}/data/radar_bev_cache/nuscenes_trainval_5sweeps_200x200_v1_radial_float32
extension_cache=${workspace}/cache/torch_extensions_m1m2
log_file=${work_dir}/strict_h200_gpu1_1g_b4_m1_m2_scratch.log
