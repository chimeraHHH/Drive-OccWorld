...
log_level = 'INFO'
work_dir = '/storage/data/metaiot_data/huayiming/RadarFlowOcc/work_dirs/m3_review_only'
load_from = None
resume_from = None
workflow = [('train', 1)]
plugin = True
...
ida_aug_conf = dict(
    reisze=[720, 765, 810, 855, 900, 945, 990, 1035, 1080],
    crop=(0, 0, 1600, 900),
    H=900,
    W=1600,
    rand_flip=True)
...
train_pipeline = [
    ...
    dict(
        ...
        to_float32=True,
        occ_path=
        '/storage/ssd/metaiot_guest/huayiming/RadarFlowOcc/datasets/nuScenes-Occupancy-v0.1',
...
data = dict(
    ...
    train=dict(
        ...
        data_root=
        '/storage/ssd/metaiot_guest/huayiming/RadarFlowOcc/datasets/nuscenes_driveocc_m1_camera_ssd/',
        ann_file=
        '/storage/ssd/metaiot_guest/huayiming/RadarFlowOcc/datasets/nuscenes_driveocc_m1_camera_ssd/nuscenes_infos_temporal_train_new.pkl',
        pipeline=[
            dict(type='LoadMultiViewImageFromFiles', to_float32=True),
            dict(type='PhotoMetricDistortionMultiViewImage'),
            dict(
    ...
    val=dict(
        ...
        '/storage/ssd/metaiot_guest/huayiming/RadarFlowOcc/datasets/nuscenes_driveocc_m1_camera_ssd/',
        ann_file=
        '/storage/ssd/metaiot_guest/huayiming/RadarFlowOcc/datasets/nuscenes_driveocc_m1_camera_ssd/nuscenes_infos_temporal_val_new.pkl',
        pipeline=[
            dict(type='LoadMultiViewImageFromFiles', to_float32=True),
            dict(
                type='NormalizeMultiviewImage',
...
radar_cfg = dict(
    ...
    time_lag_norm=0.5,
    cache_dir=
    'data/radar_bev_cache/nuscenes_trainval_5sweeps_200x200_v0_float32',
    cache_readonly=True)
radar_observation_cfg = dict(
    point_cloud_range=[-51.2, -51.2, -5.0, 51.2, 51.2, 3.0],
    bev_h=200,
...
m3_protocol = dict(
    ...
    backbone_norm_requires_grad=False,
    note=
    'GPU count/global batch and software revision must be logged by launcher')
