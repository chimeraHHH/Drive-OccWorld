...
resume_from = '/storage/data/metaiot_data/huayiming/RadarFlowOcc/work_dirs/gmo_radar_m1_v0_l40s720_cached_w2_4g_b1_seed0_scratch/epoch_12.pth'
workflow = [('train', 1)]
plugin = True
...
data = dict(
    ...
    train=dict(
        ...
        data_root='data/nuscenes/',
        ann_file='data/nuscenes/nuscenes_infos_temporal_train_new.pkl',
        pipeline=[
            dict(type='LoadMultiViewImageFromFiles', to_float32=True),
            dict(type='PhotoMetricDistortionMultiViewImage'),
            dict(
    ...
    val=dict(
        type='NuScenesWorldDatasetV1',
        data_root='data/nuscenes/',
        ann_file='data/nuscenes/nuscenes_infos_temporal_val_new.pkl',
        pipeline=[
            dict(type='LoadMultiViewImageFromFiles', to_float32=True),
            dict(
                type='NormalizeMultiviewImage',
